...
_C.DATASETS = CN()
# Root dir of dataset
_C.DATASETS.ROOT_DIR = "D:/Study/Lab/Competition/AIEarth/code/data/enso_round1_train_20210201/"
# Fold to validate
...
_C.TEST.WEIGHT = os.path.abspath(os.path.join(os.getcwd(), "../../test/usr_data/model_data/"))+"best-checkpoint.bin"

# ---------------------------------------------------------------------------- #
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = os.path.abspath(os.path.join(os.getcwd(), "../../test/usr_data/model_data/"))
